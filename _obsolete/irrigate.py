...
def main():
	...
	try:
		running = True
		while running:
			set_pin(pin_id_pump, 		True)
			set_pin(pin_id_sensors, 	False)
			set_pin(pin_id_valve_sewage,	False)
			set_pin(pin_id_valve_refill,	False)
			set_pin(pin_id_valve_filter, 	False)
			set_pin(pin_id_valve_group_3,	True)
			set_pin(pin_id_valve_group_2,	False)
			set_pin(pin_id_valve_group_1,	True)
